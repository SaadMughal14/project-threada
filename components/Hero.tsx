    ...
    <section ref={container} className="h-[75dvh] md:h-[90dvh] w-full flex items-center justify-center relative bg-[#F2DCE0] overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center w-full max-w-full px-4 md:px-8">
        ...
        <div className="studio-details flex flex-col items-center mt-4 md:mt-10 text-center space-y-4 md:space-y-8">
           <div className="flex items-center gap-3 md:gap-10 opacity-60 w-full justify-center px-4">
             <span className="font-black uppercase text-[8px] md:text-[14px] tracking-[0.5em] md:tracking-[1em] whitespace-nowrap text-[#1C1C1C]">Sculpted by Heat</span>
           </div>
           
           <div className="space-y-2 px-2">
             <p className="font-black text-[#1C1C1C]/90 uppercase text-[12px] md:text-3xl tracking-[0.15em] md:tracking-[0.3em] leading-tight max-w-2xl mx-auto">
               Defined by gravity.
             </p>
             <p className="text-[#D97B8D] opacity-60 uppercase text-[7px] md:text-[10px] font-black tracking-[0.4em] italic">
