...
const BrownieSVG = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-2xl">
    ...
    <circle cx="30" cy="65" r="3" fill="#D4AF37" opacity="0.4" />
    <circle cx="70" cy="30" r="2" fill="#D4AF37" opacity="0.4" />
  </svg>
);
...
const CakeSVG = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-2xl">
    ...
    <path d="M20 50 L80 50 L80 70 L20 70 Z" fill="#D4AF37" />
...
const Hero: React.FC = () => {
  ...
  useGSAP(() => {
    ...
    driftElements.forEach((el: any, i) => {
      // More aggressive and varied movement
  ...
  return (
    <section ref={container} className="h-[75dvh] md:h-[90dvh] w-full flex items-center justify-center relative bg-[#1C1C1C] overflow-hidden">
      
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#1C1C1C]/90 via-transparent to-[#1C1C1C] z-10"></div>
        <video 
          ref={videoRef}
          autoPlay muted loop playsInline 
          className="w-full h-full object-cover scale-105 opacity-[0.15] will-change-transform grayscale"
        >
      ...
      <div ref={driftLayerRef} className="absolute inset-0 z-10 pointer-events-none overflow-hidden">
        {[...Array(24)].map((_, i) => {
          const type = i % 3;
          return (
            <div 
      ...
      <div className="relative z-20 flex flex-col items-center w-full max-w-full px-4 md:px-8">
        <div className="overflow-hidden w-full flex justify-center">
          <h1 className="hero-title font-display text-hero font-black text-[#FDFCFB] uppercase select-none will-change-transform">
              GRAVITY
          </h1>
        </div>
        ...
        <div className="studio-details flex flex-col items-center mt-4 md:mt-10 text-center space-y-4 md:space-y-8">
           ...
           <div className="space-y-2 px-2">
             <p className="font-black text-[#FDFCFB]/90 uppercase text-[12px] md:text-3xl tracking-[0.15em] md:tracking-[0.3em] leading-tight max-w-2xl mx-auto">
               Defined by gravity.
             </p>
             <p className="text-[#D4AF37] opacity-40 uppercase text-[7px] md:text-[10px] font-black tracking-[0.4em] italic">
